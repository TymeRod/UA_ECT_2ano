...
int main(void)
{
  person p = person("John Doe","ali",966543621); // create a new object and then copy it to p
  person q("Not John Doe","aqui",165234852);           // create a new object (no copy needed)

  cout << "Before change of address: " << p.get_name() << ", " << p.get_address() << ", " << p.get_number() << endl;
  p.set_address("bench 24, Central Park, New York");
  p.set_name("Joao Joao");
  p.set_number(45123781);
